...
def generate_deeplink_simple(companyName, service_id, consumer = None):
  ...
  if consumer == None: #Es deeplink sin codigo de pago
    ...
    deeplink = f"https://yape.com.pe/app/services-pay/pickService?logo={ruta_logo}&companyId={company_id}&name={company_encoded}&serviceId={service_id}&consumerCode={normalize(consumer)}"
